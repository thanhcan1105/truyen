...
import 'package:truyen/app/screens/example_story/read/read_story_screen.dart';
import 'package:truyen/app/screens/story/list_chapter.dart';

class StoryDetailExample extends StatelessWidget {
  StoryDetailExample({super.key});

  ExampleController controller = Get.put(ExampleController(), permanent: true);
